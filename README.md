...
- Shows one total progress bar using the account email total, with archived coverage, new downloads, transfer speed, elapsed time, and a grouped final summary.
